...
df=pd.read_csv ('horse_colic_data_head.csv', delimiter=' ') #, low_memory=False)
...
# Verifiaction de l'unicité des ColumnID :
...
# On vérifie s'il n'y a pas de date illogiques.
